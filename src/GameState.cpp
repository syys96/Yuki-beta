...
void GameState::set_timecontrol(int maintime) {
    TimeControl timecontrol(board.get_boardsize(), maintime);
...
void GameState::adjust_time(int color, int time) {
    m_timecontrol.adjust_time(color, time);
}
